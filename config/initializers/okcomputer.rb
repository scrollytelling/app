...
OkComputer::Registry.register "resque_down",
  OkComputer::ResqueDownCheck.new
...
OkComputer::Registry.register "shared_uploads",
  OkComputer::DirectoryCheck.new("/efs/uploads")
