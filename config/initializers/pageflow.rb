...
Pageflow.configure do |config|
  ...
  %w(radio1 nos volkskrant grasnapolsky beeldengeluid psv stephaniestruijk amnesty blof knvb buildingbridges).each do |account|
  ...
  config.themes.register(:blof)
  config.themes.register(:knvb)
  config.themes.register(:buildingbridges)
